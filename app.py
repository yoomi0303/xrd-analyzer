...
MINERAL_DB = {
    ...
    "Quartz (SiO2)": { "peaks": [20.8, 26.6, 50.1], "marker": "x", "color": "purple" },
    "Gypsum": { "peaks": [11.6, 20.7], "marker": "1", "color": "cyan" },
